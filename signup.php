                ...
                <div class="card-body">
                    ...
                    <form action="./includes/signup.inc.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <small id="idHelp" class="form-text text=muted"><strong>This will be your login</strong></small>
                        </div>
                        <!-- Phone -->
                        <div class="col-mb-3">
                            <label for="confirm_password" class="form-label"><strong>Phone Number</strong></label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" id="password" name="password" autocomplete="new-password" class=" form-control" placeholder="Enter your password" required>
                            <span id="passwordHelpInline" class="form-text">
                                Must not contain spaces, emoji.
                        </div>
                        <!-- Confirm Password -->
                        <div class="col-mb-3">
